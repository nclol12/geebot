...
client.on('message', async message => {
    ...
    if(command == "daily") {
        ...
        message.channel.send(new Discord.MessageEmbed()
            .setTitle("Daily!")
            .setDescription(`Your new balance is now ${currentBalance + 5}!`).setColor("00ff00")
        )
    ...
    if(command == "bal") {
        ...
        message.channel.send(new Discord.MessageEmbed()
            .setTitle("Balance!")
            .setDescription(`Your balance is \`${currentBalance}\``).setColor("00ff00")
        )
    }
});
